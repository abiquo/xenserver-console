...
import com.citrix.xenserver.console.examples.JavaInitialize;
...
public class XenServerStandalone extends JFrame
{
    ...
    /**
     * Get the Applet parameters from the HTML file
     */
